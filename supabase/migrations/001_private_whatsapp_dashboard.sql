-- Private WhatsApp dashboard (single-tenant)
...
create index if not exists contacts_last_message_at_idx on public.contacts (last_message_at);
create index if not exists messages_contact_id_created_at_idx on public.messages (contact_id, created_at);
create index if not exists messages_whatsapp_message_id_idx on public.messages (whatsapp_message_id);
create index if not exists training_knowledge_active_idx on public.training_knowledge (active);
